...
public class ControlEvent : MonoBehaviour ,IEventSystemHandler {
	...
	List<string> nameOffices =
		new List<string>();
	static Vector3 center = new Vector3 (284.5F, 0.9F, 205.0F);
	static Vector3 orginalPostion = new Vector3 (319.1F, 64.7F, 248.5F);
	...
	static Vector3 centerOld = new Vector3 (287.1F, 10.0F, 205.0F);
	static Vector3 orginalPostionOld = new Vector3 (287.6F, 44.0F, 232.9F);
	...
	*/
	...
	public void showBlock(int blockNumber){
		...
		if(blockNumber == 9)
			...
			setCamera (orginalPostionOld, centerOld);
		else
	...
	bool isBathRoomSearch = false, firsShowBathroom = false;

	public void bathRoomPressShowNext(){
