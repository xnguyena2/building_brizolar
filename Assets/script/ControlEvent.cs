...
public class ControlEvent : MonoBehaviour ,IEventSystemHandler {
	...
	public void handicapMode(){
		...
		if (!handicap) {
			...
			blockSelectorimg.sprite = ResourcesDictionary[currentLanguage+"blockselector"];GameObject.Find("containresultoffice").GetComponent<Image>().sprite = ResourcesDictionary["officebackground"];
